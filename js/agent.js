/* =============================================
   ZYLOVA — Live AI Agent  v2
   Powered by Anthropic Claude API

   HOW TO SET YOUR API KEY:
   1. Go to https://console.anthropic.com
   2. Create an API key under "API Keys"
   3. Replace "YOUR_ANTHROPIC_API_KEY" below
      OR set it via your hosting environment
      variables (never commit keys to Git).

   DEPLOYMENT TIP:
   On Netlify: Site Settings > Environment Variables
   Add: ANTHROPIC_API_KEY = sk-ant-...
   Then use a serverless function to proxy calls.
